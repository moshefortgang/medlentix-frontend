            ...
            <div className="flex-col min-h-full px-0 flex flex-wrap items-center justify-between w-full mx-auto overflow-y-auto overflow-x-hidden">
              <div className="flex bg-white flex-col items-stretch opacity-100 relative mt-4 overflow-y-auto overflow-x-hidden h-auto z-40 flex-1 rounded w-full">
                <div className="md:flex-col md:min-w-full flex flex-col list-none">
                  ...
                  <a href="javascript:;" className="text-xs uppercase py-3 font-bold block text-blueGray-800 hover:text-blueGray-500"><i className="fas fa-newspaper mr-2 text-sm text-blueGray-400"></i>Page 1 for Section 3</a>
                  <a href="javascript:;" className="text-xs uppercase py-3 font-bold block text-blueGray-800 hover:text-blueGray-500"><i className="fas fa-user-circle mr-2 text-sm text-blueGray-400"></i>Page 2 for Section 3</a>
                  <a href="javascript:;" className="text-xs uppercase py-3 font-bold block text-blueGray-800 hover:text-blueGray-500"><i className="fas fa-paint-brush mr-2 text-sm text-blueGray-400"></i>Page 3 for Section 3</a>
                  <hr className="my-4 md:min-w-full" />
                  <h6 className="md:min-w-full text-blueGray-500 text-xs uppercase font-bold block pt-1 pb-4 no-underline">Section 4</h6>
                  <a href="javascript:;" className="text-xs uppercase py-3 font-bold block text-blueGray-800 hover:text-blueGray-500"><i className="fab fa-angular mr-2 text-sm text-blueGray-400"></i>Page 1 for Section 4</a>
                  <a href="javascript:;" className="text-xs uppercase py-3 font-bold block text-blueGray-800 hover:text-blueGray-500"><i className="fab fa-react mr-2 text-sm text-blueGray-400"></i>Page 2 for Section 4</a>
                  <a href="javascript:;" className="text-xs uppercase py-3 font-bold block text-blueGray-800 hover:text-blueGray-500"><i className="fab fa-vuejs mr-2 text-sm text-blueGray-400"></i>Page 3 for Section 4</a>
                </div>
              </div>
            </div>
          </nav>
          <div className="relative md:mr-64 bg-blueGray-100 w-full">
            <div className="px-4 md:px-6 mx-auto w-full">
              <div className="flex flex-wrap">
                <div className="w-full xl:w-8/12 px-4 overflow-y-auto h-screen">
